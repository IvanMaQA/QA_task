...
public class BasePage {
    ...
    public void moveThePointerToElement(By elementBy) {
        waitVisibility(elementBy);
        Actions action = new Actions(driver);
        action.moveToElement(driver.findElement(elementBy)).build().perform();

    }
    public void selectFromDropdownByValue(By elementBy, String value){
        Select select = new Select(driver.findElement(elementBy));
